...
namespace ServiceBusTopic
{
    class Program
    {
        static string connectionString = "Endpoint=sb://pk11servicebus.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=dXnrp4ojXaX9sNk8I0Pf7M3rsgtAew4FBTkI/FRi95c=";
        static string topicName = "pktopic";
        static string subscriptionName = "S2";
